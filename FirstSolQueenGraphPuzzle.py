...
def initial_solution(n):
    ...
    if n == 1:
        ...
        return board
    if n in [2, 3]:
        raise ValueError("No Solution for n = 2 or n = 3.")
    ...
    if r in [0, 4]:
        ...
        print("The use of the first class: A (A1 and A2)")
    ...
    # second case : n = 6k+1 ou n = 6k+5
        ...
        print("The use of the second class B (B1, B2 and B3)")
    ...
    # third case: n = 6k+2
        ...
        print("The use of the third class C (C1 to C8)")
    ...
    # Fourth case : n = 6k+3
        ...
        print("The use of the fourth class ")
